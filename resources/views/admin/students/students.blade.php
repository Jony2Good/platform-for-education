        ...
        <div class="row">
            <main class="col-sm-10 col-md-9 ms-sm-auto col-lg-10 col-xl-9">
                <div class="content news bg-light schedule m-xs-0 p-xs-0 m-sm-0 p-sm-0 p-xl-5 mt-xl-3 rounded-3">
                    ...
                    <hr>
                    <div class="teachers-list students-list d-flex flex-wrap align-items-start mt-4 gap-3">
                        <div class="w-100"><h5 class="fw-bold">2 класс</h5></div>
                        <div class="teacher student bg-white rounded-3 p-4 col">
                            <div class="teacher-top mb-2 d-flex justify-content-between">
                                <div class="info ml-3">
                                    <div class="image me-3"></div>
                                    <div class="info-name">
                                        <h6 class="mb-1">Григорьева Е.</h6>
                                        <small class="text-muted">2 класс, скрипка</small>
                                    </div>
                                </div>
                            ...
                            <div class="w-75">8-911-876-54-32</div>
                            <div class="w-75">mymail@gmal.com</div>
                        </div>
                        <div class="teacher student bg-white rounded-3 p-4 col">
                            <div class="teacher-top mb-2 d-flex justify-content-between">
                                <div class="info ml-3">
                    ...
                    <div class="teachers-list students-list d-flex flex-wrap align-items-start mt-4 gap-3">
                        <div class="w-100"><h5 class="fw-bold">3 класс</h5></div>
                        <div class="teacher student bg-white rounded-3 p-4 col">
                            <div class="teacher-top mb-2 d-flex justify-content-between">
                                <div class="info ml-3">
                                    <div class="image me-3"></div>
