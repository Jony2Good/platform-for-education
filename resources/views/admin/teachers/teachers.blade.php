        ...
        <div class="row">
            <main class="col-sm-10 col-md-9 ms-sm-auto col-lg-10 col-xl-9">
                <div class="content bg-light schedule m-xs-0 p-xs-0 m-sm-0 p-sm-0 p-xl-5 mt-xl-3 rounded-3">
                    ...
                    <div class="schedule-actions d-flex align-items-start justify-content-start">
                        <a href="{{ route('school.add.teacher') }}" class="btn btn-primary">Добавить преподавателя</a>
                    </div>
                    <div class="teachers-list d-flex align-items-start mt-4 gap-3">
                        <div class="teacher bg-white rounded-3 p-4 col-xl-4">
                            <div class="teacher-top mb-2 d-flex justify-content-between">
                                <div class="info ml-3">
                                    <div class="image me-3"></div>
                                    <div class="info-name">
                                        <h6 class="mb-1">Петров М.К.</h6>
                                        <small class="text-muted">Концертмейстер</small>
                                    </div>
                                </div>
                            ...
                            <span class="w-75">Lorem Ipsum has been the industry's standard dummy text ever since the 1500</span>
                        </div>
                        <div class="teacher bg-white rounded-3 p-4 col-xl-4">
                            <div class="teacher-top mb-2 d-flex justify-content-between">
                                <div class="info ml-3">
                            ...
                            <span class="w-75">Lorem Ipsum has been the industry's standard dummy text ever since the 1500</span>
                            <a href="#" class="btn w-100 text-primary border-primary rounded-2 mt-3">+ Добавить урок</a>
                        </div>
                    </div>
                </div>
            </main>
